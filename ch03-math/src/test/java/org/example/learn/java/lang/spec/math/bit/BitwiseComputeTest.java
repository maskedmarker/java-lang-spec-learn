...
public class BitwiseComputeTest {
    ...
    public int clear(int word, int n) {
        if (n > 32) {
            throw new RuntimeException("n > 32");
        }
     ...
     *     当b为0时, (a^b)值与a的值相同
     */
    public int toggle(int word, int n) {
        if (n > 32) {
            throw new RuntimeException("n > 32");
        }
    ...
    public int read(int word, int n) {
        if (n > 32) {
            throw new RuntimeException("n > 32");
        }
    ...
    public int read2(int word, int n) {
        if (n > 32) {
            throw new RuntimeException("n > 32");
        }
